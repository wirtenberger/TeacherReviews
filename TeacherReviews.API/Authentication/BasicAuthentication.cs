...
namespace TeacherReviews.API.Authentication;
...
public class BasicAuthenticationHandler : AuthenticationHandler<BasicAuthenticationSchemeOptions>
{
    ...
    {
        var adminUserService = Context.RequestServices.GetRequiredService<AdminUserService>();
        ...
        if (!await adminUserService.IsAuthenticated(username, password))
        {
            Context.Response.StatusCode = StatusCodes.Status401Unauthorized;
